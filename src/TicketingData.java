public class TicketingData {
    ...
    public TicketingData(String schedule_no, String route_no, int ticket_from_stop_id,
                         int ticket_from_stop_seq_no, int ticket_till_stop_id, int ticket_till_stop_seq_no,
                         String ticket_date, String ticket_time, double total_ticket_amount, float travelledKM) {
        this.travelledKM = travelledKM;
        this.schedule_no = schedule_no;
        this.route_no = route_no;
        this.ticket_from_stop_id = ticket_from_stop_id;
